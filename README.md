...
> **[v1.3.2-dev.1](https://github.com/ahmedyarub/morphe-patches/releases/tag/v1.3.2-dev.1)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;13 patches total
<details open>
...
| [Disable analytics](#disable-analytics) | Blocks analytics requests sent to Instagram and Facebook servers. Off by default: earlier builds crashed the app. |  |
...
| [Open links externally](#open-links-externally) | Opens links in the system browser instead of the in-app browser. Off by default: its fingerprint anchors on strings that Instagram 446 moved into a string factory, so the matched method has not been confirmed. |  |
| [Sanitize share links](#sanitize-share-links) | Removes tracking parameters from links shared out of the app. Off by default: an earlier build crashed the app when copying a link. |  |
